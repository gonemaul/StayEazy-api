...
<head>
    ...
    <title>Hotel Reservation Documentation</title>
...
<body class="bg-gray-100 font-sans">
    @if (!request()->routeIs('home'))
            <div class="flex">
        <div class="md:hidden fixed top-0 left-0 right-0 bg-white shadow z-40 flex justify-between items-center px-4 h-16">
        <h1 class="text-lg font-semibold">📘 StayEazy Docs</h1>
    ...
    <h2 class="text-2xl font-bold mb-6 text-center text-blue-600">StayEazy Docs</h2>
...
<div class="md:ml-64 md:pt-10 pt-20 px-10 pb-10 w-full min-h-screen {{ request()->routeIs('docs.overview') ? "bg-gray-50" : "bg-blue-50"}}">
    @yield('content')
</div>
<script>
